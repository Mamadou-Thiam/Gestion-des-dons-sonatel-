...
const CategorieThemeService = {
  fetchCategorieTheme: async (page, size, sort, filter) => {
    try {
  ...
  getCategorieThemeById: async (id) => {
    try {
  ...
  createCategorieTheme: async (patientData) => {
    try {
  ...
  updateCategorieTheme: async (id, patientData) => {
    try {
...
export default CategorieThemeService;
