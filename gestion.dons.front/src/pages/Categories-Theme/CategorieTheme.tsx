  ...
  const handleDeleteTheme = (id: number) => {
    axios
      ...
      .then(() => {
        ...
        setData(updatedData);
        message.success("catégorie theme supprimé avec succès !");
      })
      .catch((err) => {
        console.log(err);
        message.error("Erreur lors de la suppression du catégorie !");
      });
  };
  ...
  const handleSaveCategorie = () => {
    form
      ...
      .then(() => {
        ...
        axios
          .post(
            "https://wesaloapi-dsiwessalo-dev.apps.malaaw-rec.orange-sonatel.com/api/categorie-themes",
            data
          )
          .then(() => {
            message.success("Thème catégorie ajouté avec succès !");
            loadData();
            handleCancel();
            setIsModalVisible(false);
          })
          .catch((err) => {
            console.log(err);
            message.error("Erreur lors de l'ajout du thème !");
          });
      })
      .catch((errorInfo) => {
    ...
    },
    {
      ...
      render: (text: any, record: any) => (
        <>
          <Space size="small">
            <Link
              to={`/update/themeCategorie/${record.key}`}
        ...
        <div style={{ display: "flex" }}>
          <div style={{ display: "flex" }}>
            <Flex gap="Large" wrap="wrap">
              ...
              <Modal
                title="Formulaire d'ajout d'un Catègorie Thème"
